...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col">
                    <form action = "addNewAd" method ="POST" class="form-horizontal">
                        Title: <input type="text" name="title" class="form-control"> <br> <br>
                        Description: <input type="text" name="description" class="form-control"> <br> <br>
                        Status: <select name="type" name="status" class="form-control" required> 
                        ...
                        Type: <select name="type" required class="form-control">
                            <option value="" selected disabled hidden>Choose...</option>
                        ...
                        Size: <input type="number" name="size" class="form-control"> <br> <br>
                        Floor: <input type="text" name="floor" class="form-control"> <br><br>
                        ...
                        latitude: <input type='text' id="lat" name='map_lat' class="form-control">
                        longitude: <input type='text' id="lng" name = 'map_lng'class="form-control"> <br> <br>

                        <input type="hidden" id="formatted_address" name="address" class="form-control">
                        Country: <input id="country" name="country"class="form-control">
                        City: <input id="administrative_area_level_1" name="city" class="form-control">
                        Region: <input id="administrative_area_level_2" name="region" class="form-control"><br>

                        <button type="submit" name="submit" value = "Add" class="btn btn-dark">Add</button>

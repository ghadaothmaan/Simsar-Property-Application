                  ...
                  <div class="row">
                        <div class="col">
                              <form action = "addNewAd" method ="POST" class="form-horizontal">
                                    ...
                                    <br>
                                    latitude:
                                    <input type='text' id='lat' name='map_lat' class="form-control">
                                    <br>
                                    longitude:
                                    <input type='text' id='lng' name = 'map_lng' class="form-control">
                                    <br>
                                    Country:
                                    <input type="text" id="administrative_area_level_2" name="country" class="form-control">
                                    <br>
                                    City:
                                    <input type="text" id="administrative_area_level_1" name="city" class="form-control">
                                    <br>
                                    Region:
                                    <input type="text" id="administrative_area_level_2" name="region" class="form-control">
                                    <br>
